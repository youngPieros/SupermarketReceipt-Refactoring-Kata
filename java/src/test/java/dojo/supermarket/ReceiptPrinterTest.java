...
public class ReceiptPrinterTest {
    ...
    public void discounts() {
        receipt.addProduct(new ProductQuantity(apples, 0));
        receipt.addDiscount(apples, Discount.createDiscount(apples, "3 for 2", 0.99));
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
    ...
    public void printWholeReceipt() {
        ...
        receipt.addProduct(new ProductQuantity(toothbrush, 2));
        receipt.addProduct(new ProductQuantity(apples, 0.75));
        receipt.addDiscount(toothbrush, Discount.createDiscount(toothbrush, "3 for 2", 0.99));
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
